function data = set_initial_data(const)
    %{
     ...
     @return    data    A struct containing both the primary and the derived
                        ...
                        r, sigma_db, and sigma_dt) for the initial
    ...
    data = struct('u', 0.1+(0*y_u'), 'ut', 0*y_u', 'w', 0.1*x', 'wt', 0*x',  ...
        'theta', 0*x', 'theta_t', 0*x', 'sigma_db', 1, 'sigma_dt', 0);
