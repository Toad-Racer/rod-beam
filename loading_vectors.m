function loads = loading_vectors(current_data, const)
    ...
    loads.f1 = (1/const.ht^2*const.Md-(const.Ed/2-const.alpha_d/const.ht)*const.Kd)*current_data.u ...
    ...
    loads.f2 = ((1/const.ht-const.zeta_d/2)*const.Md(2:end, 2:end)... 
         ...
         - [zeros(const.num_nodes-2, 1); K(current_data.r)/2*current_data.phi(end)];
